...
import { aprovarNotaFiscal, rejeitarNotaFiscal } from "@/lib/loyalty.functions";
...
function Page() {
  ...
  const aprovar = useMutation({
    ...
    onSuccess: () => {
      toast.success("Aprovada e pontos creditados!");
              ...
              return (
                <div key={n.id} className="border rounded-md p-3 space-y-2">
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    ...
                    <Button size="sm" variant="outline" onClick={() => openImage(n.image_path)}>
                  ...
                  <div className="flex items-end gap-2 flex-wrap">
                    ...
                    <Button
                      size="sm"
                      disabled={aprovar.isPending || !valorFinal}
                    ...
                    <Button
                      ...
                      onClick={() =>
                        rejeitar.mutate({ id: n.id, motivo: "Rejeitada pelo lojista" })
                      }
                    >
          ...
          {historico.length === 0 ? (
            ...
            historico.slice(0, 50).map((n) => (
              ...
              >
                ...
                <Badge variant={n.status === "aprovada" ? "default" : "destructive"}>
                  {n.status}
                  {n.pontos_creditados ? ` · +${n.pontos_creditados} pts` : ""}
                </Badge>
              </div>
            ))
          )}
