...
import { atualizarLoja } from "@/lib/loyalty.functions";
              ...
              return (
                <button
                  ...
                  className={`w-full text-left flex items-center gap-3 rounded-xl px-3 py-2.5 transition-colors ${
                    active ? "bg-[#EEF2FF] text-[#1D4ED8]" : "text-[#334155] hover:bg-[#F8FAFC]"
                  }`}
                >
                  <span
              ...
              <Card className="rounded-2xl border-[#E5E7EB] shadow-sm overflow-hidden">
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-xs text-[#64748B]">
                    As cores da sua marca pintam a aura de fundo, o logo, a barra de progresso e o
                    botão de resgate na página do cliente.
                    <a
                      href={`/${loja.slug}`}
                      target="_blank"
                      rel="noreferrer"
                ...
                {inclC && (
                  <div>
                    ...
                    <p className="text-xs text-[#64748B] mt-1">
                      O cliente só poderá usar o voucher de cashback em compras a partir desse
                      valor. Deixe em <strong>0</strong> para permitir uso em qualquer compra.
                    </p>
                  </div>
                )}
                <div>
                ...
                <div className="rounded-xl border border-[#E5E7EB] bg-[#F8FAFC] p-4 space-y-3">
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="text-xs text-[#64748B]">
                      ...
                      Se ligado, o cliente continua vendo o voucher como "Utilizado" na lista dele.
                      Se desligado (padrão), o voucher some assim que você confirma a entrega.
                    </div>
                    <Switch
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="text-xs text-[#64748B]">
                      ...
                      Se ligado (padrão), o cliente vê os vouchers expirados como aviso. Desligue
                      para escondê-los.
                    </div>
                    <Switch
